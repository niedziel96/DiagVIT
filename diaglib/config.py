...
PREDICTIONS_PATH = PROJECT_ROOT_PATH / 'predictions'
PARAMS_PATH = PROJECT_ROOT_PATH / 'params'
...
SEGSET_ROOT_PATH = DATA_PATH / 'SegSet'
SEGSET_TRAIN_SET_PATH = SEGSET_ROOT_PATH / 'train'
SEGSET_TEST_SET_PATH = SEGSET_ROOT_PATH / 'test'
